...
#include "GMCRootMotionModifier.generated.h"
...
class GMCMOTIONWARPING_API URootMotionModifier : public UObject
{
	GENERATED_BODY()
...
struct GMCMOTIONWARPING_API FMotionWarpingTarget
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class GMCMOTIONWARPING_API URootMotionModifier_Warp : public URootMotionModifier
{
	GENERATED_BODY()
...
class GMCMOTIONWARPING_API UDEPRECATED_RootMotionModifier_SimpleWarp : public URootMotionModifier_Warp
{
	GENERATED_BODY()
...
class GMCMOTIONWARPING_API URootMotionModifier_Scale : public URootMotionModifier
{
	GENERATED_BODY()
