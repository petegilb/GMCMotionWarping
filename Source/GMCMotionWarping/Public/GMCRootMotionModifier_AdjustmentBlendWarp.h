...
#include "GMCRootMotionModifier_AdjustmentBlendWarp.generated.h"
...
class GMCMOTIONWARPING_API URootMotionModifier_AdjustmentBlendWarp : public URootMotionModifier_Warp
{
	GENERATED_BODY()
...
public:
	...
	static void GetAdjustmentBlendIKBoneTransformAndAlpha(APawn* Character, FName BoneName, FTransform& OutTransform, float& OutAlpha);
